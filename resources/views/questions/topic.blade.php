...
<html lang="en">
	...
	<body>
				...
				<div class="col-md-12">
					<article class="blog-post">
						<div class="blog-post-body">
							<!-- 更改话题 -->
							@if(Auth::check() && Topic::ownss($topic))
                            	<a title="更改话题" style="cursor:pointer;margin-left:5px;position:relative;" class="fa fa-asl-interpreting ht" data-toggle="modal" topicsid='' data-target="#topicc"></a>
                            @endif
                            <!-- end -->
		...
		<!-- 更改话题模态框 -->
		<div id='topicc' class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">

					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="myModalLabel">更改话题</h4>
					</div>
					<div class="modal-body">
						<div class="media">
							<div class="media-body">
								<div class="media-heading">
									{!!Form::open(['url'=>action('QuestionController@genggai',['id'=>$topic->id]),'method'=>'POST','files'=>true])!!}
									{!! Form::hidden('id',$topic->id) !!}

									<div class="form-group">
									{!! Form::label('name','更改话题名称')!!}
									{!! Form::text('name',null,['class'=>'form-control','placeholer'=>'请输入话题名称','required'=>'required','placeholder'=>$topic->name]) !!}
									</div>
									<div class="form-group">
									{!! Form::label('desc','更改话题描述')!!}
									{!! Form::text('desc',null,['class'=>'form-control','placeholer'=>'请输入话题话题描述','required'=>'required','placeholder'=>$topic->desc]) !!}
									</div>
									<div class="form-group">
									{!! Form::label('title','更改话题图片')!!}
									{!! Form::file('avatar') !!}
									<img width='200px' height='200px' src="{{$topic->topic_pic}}">
									</div>
									{!!Form::submit('提交话题',['class'=>'btn btn-info btn-block'])!!}
									{!!Form::close()!!}
								</div>
